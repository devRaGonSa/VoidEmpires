...
public sealed class DevStrategicMapActionManifestService : IDevStrategicMapActionManifestService
{
    ...
    [
        Read("strategicMap.read", "Read strategic map", "GET", "/api/dev/strategic-map", [Field("civilizationId", "Guid")], "Returns civilization-scoped relevant systems, planet summaries, fleet presence, transfer overlays, and route/fuel capability notes."),
