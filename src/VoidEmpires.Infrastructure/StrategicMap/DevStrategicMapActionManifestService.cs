...
public sealed class DevStrategicMapActionManifestService : IDevStrategicMapActionManifestService
{
    ...
    [
        Read("strategicMap.read", "Read strategic map", "GET", "/api/dev/strategic-map", [Field("civilizationId", "Guid")], "Returns civilization-scoped relevant systems, planet summaries, fleet presence, transfer overlays, command availability metadata, diplomacy contact metadata, exploration preview metadata, and route/fuel capability notes."),
        ...
        Read("interception.opportunity.read", "Read interception opportunities", "GET", "/api/dev/strategic-map/interception-opportunities", [Field("civilizationId", "Guid")], "Returns read-only interception readiness metadata for active transfers. It does not execute interception, combat, damage, or interception resolution."),
        Read("alliance.readiness.read", "Read alliance readiness", "GET", "/api/dev/strategic-map/alliances/readiness", [Field("civilizationId", "Guid")], "Returns read-only requesting-civilization alliance membership metadata. It does not grant shared visibility, permissions, pacts, trade, war, espionage, or combat behavior."),
        Read("alliance.pact.readiness.read", "Read alliance pact readiness", "GET", "/api/dev/strategic-map/alliances/pacts/readiness", [Field("civilizationId", "Guid")], "Returns read-only requesting-civilization alliance pact metadata. It does not grant shared visibility, permissions, trade, war, defense automation, espionage, or combat behavior."),
        Read("diplomacy.contact.read", "Read diplomatic contacts", "GET", "/api/dev/strategic-map/diplomatic-contacts", [Field("civilizationId", "Guid")], "Returns read-only civilization-scoped diplomatic contact metadata. It does not create alliances, pacts, trade, espionage, war, visibility reveal, or diplomacy gameplay state."),
