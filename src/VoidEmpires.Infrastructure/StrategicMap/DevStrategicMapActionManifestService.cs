...
public sealed class DevStrategicMapActionManifestService : IDevStrategicMapActionManifestService
{
    ...
    [
        ...
        Mutating("exploration.mission.completeDue", "Complete due exploration missions", "POST", "/api/dev/strategic-map/exploration-missions/complete-due", [Field("nowUtc", "DateTime")], 200, "Marks due planned exploration missions completed. It does not reveal visibility, create known-system state, assign rewards, run sensors, or mutate fog-of-war."),
