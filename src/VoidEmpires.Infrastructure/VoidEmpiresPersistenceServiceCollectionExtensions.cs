...
public static class VoidEmpiresPersistenceServiceCollectionExtensions
{
        ...
        string? provider = null)
    {
        ...
        services.AddScoped<IGameplayQueueMaterializationService, GameplayQueueMaterializationService>();
        services.AddScoped<IGameplayRefreshService, GameplayRefreshService>();
        ...
        services.AddScoped<IDevAllianceUiStateService, DevAllianceUiStateService>();
        services.AddScoped<IDevRankingUiStateService, DevRankingUiStateService>();
