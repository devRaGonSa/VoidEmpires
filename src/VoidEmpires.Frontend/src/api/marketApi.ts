...
import type { MarketUiStateResponse } from "./marketTypes";
...
export function fetchMarketUiState(civilizationId: string, planetId?: string | null) {
  return requestJson<MarketUiStateResponse>("/api/dev/market/ui-state", {
    civilizationId,
    ...(planetId ? { planetId } : {}),
  });
}
