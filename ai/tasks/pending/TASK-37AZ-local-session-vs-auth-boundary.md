...
---
id: TASK-37AZ
title: Local session vs auth boundary
status: pending
type: frontend
team: frontend
...
## Goal
Make UI copy explicit that local session is navigation convenience, not authentication.
...
- The task goal is completed: Make UI copy explicit that local session is navigation convenience, not authentication.
...
4. Commit with a clear TASK-37AZ message.
