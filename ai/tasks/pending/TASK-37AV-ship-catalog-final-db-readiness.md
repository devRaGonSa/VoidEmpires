...
---
id: TASK-37AV
title: Ship catalog final DB readiness
status: pending
type: documentation
team: gameplay
...
## Goal
Document and prepare ship/orbital catalog classes, roles, costs, build times, requirements, and image keys.
...
- The task goal is completed: Document and prepare ship/orbital catalog classes, roles, costs, build times, requirements, and image keys.
...
4. Commit with a clear TASK-37AV message.
