...
---
id: TASK-37F
title: Page header component final
status: pending
type: frontend
team: frontend
...
## Goal
Add or refine reusable page header/context components for concise titles, purpose, status, and context.
...
- The task goal is completed: Add or refine reusable page header/context components for concise titles, purpose, status, and context.
...
4. Commit with a clear TASK-37F message.
