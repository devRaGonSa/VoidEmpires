...
---
id: TASK-38U
title: Civilization starting data finalization
status: pending
type: backend
team: gameplay
...
## Goal
Define the final starting civilization and home-planet data expectations while preserving the current safe development bootstrap.
...
9. Document or implement the authoritative starting resources, initial buildings, initial research, and home planet generation expectations that the final database phase should use.
10. Clearly separate current Development-safe bootstrap values from the intended production baseline and do not introduce production auth changes.
...
- Starting civilization expectations cover resources, buildings, research, and home planet assignment.
- Development-safe versus final-target behavior is documented clearly.
