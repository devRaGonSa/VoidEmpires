...
## Goal
Prepare final resource catalog metadata and clarify product terminology without changing the underlying economy accidentally.
...
9. Define or confirm Credits, Metal, Crystal or Cristal, Gas, Energy or Energia, and Population if the model supports it, including display order and descriptions.
10. Clarify whether Credits and Energy are separate concepts and keep backend economics unchanged unless a tested correction is required.
...
- Resource catalog metadata defines labels, descriptions, ordering, and image or icon keys consistently.
- Any economy-level behavior change is avoided or explicitly tested and documented.
