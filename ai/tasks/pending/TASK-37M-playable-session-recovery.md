...
---
id: TASK-37M
title: Playable session recovery
status: pending
type: frontend
team: frontend
...
## Goal
Improve missing-id flows so pages recover through local session links without breaking seeded URLs.
...
- The task goal is completed: Improve missing-id flows so pages recover through local session links without breaking seeded URLs.
...
4. Commit with a clear TASK-37M message.
