...
---
id: TASK-37AR
title: Placeholder asset components
status: pending
type: frontend
team: frontend
...
## Goal
Add reusable PlaceholderAsset component/card area with type, label, future image slot, and consistent styling.
...
- The task goal is completed: Add reusable PlaceholderAsset component/card area with type, label, future image slot, and consistent styling.
...
4. Commit with a clear TASK-37AR message.
