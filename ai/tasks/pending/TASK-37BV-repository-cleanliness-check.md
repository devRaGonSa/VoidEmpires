...
---
id: TASK-37BV
title: Repository cleanliness check
status: pending
type: validation
team: platform
...
## Goal
Ensure no temporary files, screenshots, build artifacts, secrets, or local machine paths were committed.
...
- docs/dev/product-readiness-report.md
- ai/current-state.md
- Optional: docs/dev/frontend-performance-notes.md

## Acceptance criteria

- The task goal is completed: Ensure no temporary files, screenshots, build artifacts, secrets, or local machine paths were committed.
...
4. Commit with a clear TASK-37BV message.
