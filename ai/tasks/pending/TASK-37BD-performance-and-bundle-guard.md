...
## Goal
Ensure new UI components preserve lazy loading and do not significantly inflate the entry chunk.
...
- The task goal is completed: Ensure new UI components preserve lazy loading and do not significantly inflate the entry chunk.
...
4. Commit with a clear TASK-37BD message.
