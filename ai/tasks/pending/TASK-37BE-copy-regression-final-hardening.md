...
---
id: TASK-37BE
title: Copy regression final hardening
status: pending
type: frontend
team: frontend
...
## Goal
Expand copy regression guard for obsolete text, mojibake, placeholders, fake resources, and forbidden wording.
...
- The task goal is completed: Expand copy regression guard for obsolete text, mojibake, placeholders, fake resources, and forbidden wording.
...
4. Commit with a clear TASK-37BE message.
