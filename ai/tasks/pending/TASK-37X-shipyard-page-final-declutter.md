...
---
id: TASK-37X
title: Shipyard page final declutter
status: pending
type: frontend
team: frontend
...
## Goal
Reorganize Shipyard around production queue, available production, stock/readiness, and Fleets handoff.
...
- The task goal is completed: Reorganize Shipyard around production queue, available production, stock/readiness, and Fleets handoff.
...
4. Commit with a clear TASK-37X message.
