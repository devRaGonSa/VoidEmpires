...
---
id: TASK-37AC
title: Fleets page product readiness
status: pending
type: frontend
team: frontend
...
## Goal
Polish Fleets as a read-only/readiness page for orbital stock/groups and future command concepts.
...
- The task goal is completed: Polish Fleets as a read-only/readiness page for orbital stock/groups and future command concepts.
...
4. Commit with a clear TASK-37AC message.
