...
---
id: TASK-37T
title: Construction queue progress polish
status: pending
type: frontend
team: frontend
...
## Goal
Improve construction queue/progress display for active, due, empty, and next-action states.
...
- The task goal is completed: Improve construction queue/progress display for active, due, empty, and next-action states.
...
4. Commit with a clear TASK-37T message.
