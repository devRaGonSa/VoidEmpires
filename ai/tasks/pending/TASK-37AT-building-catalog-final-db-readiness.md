...
---
id: TASK-37AT
title: Building catalog final DB readiness
status: pending
type: documentation
team: gameplay
...
## Goal
Document and prepare building catalog entries, metadata gaps, image keys, balance notes, and seed requirements.
...
- The task goal is completed: Document and prepare building catalog entries, metadata gaps, image keys, balance notes, and seed requirements.
...
4. Commit with a clear TASK-37AT message.
