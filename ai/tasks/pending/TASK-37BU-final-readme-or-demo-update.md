...
---
id: TASK-37BU
title: Final README or demo update
status: pending
type: documentation
team: platform
...
## Goal
Update README or docs entry point with near-product demo instructions and Development-only caveats.
...
- The task goal is completed: Update README or docs entry point with near-product demo instructions and Development-only caveats.
...
4. Commit with a clear TASK-37BU message.
