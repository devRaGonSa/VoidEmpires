...
---
id: TASK-37P
title: Planet economy actions devtools
status: pending
type: frontend
team: frontend
...
## Goal
Move resource accrual/materialization actions into DevelopmentToolsPanel with GameModal confirmation.
...
- The task goal is completed: Move resource accrual/materialization actions into DevelopmentToolsPanel with GameModal confirmation.
...
4. Commit with a clear TASK-37P message.
