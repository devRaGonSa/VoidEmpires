...
---
id: TASK-37BK
title: End-to-end smoke flow tests backend
status: pending
type: test
team: platform
...
## Goal
Add or strengthen backend tests for the playable loop and diagnostics no-mutation.
...
- The task goal is completed: Add or strengthen backend tests for the playable loop and diagnostics no-mutation.
...
4. Commit with a clear TASK-37BK message.
