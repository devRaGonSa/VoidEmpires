...
---
id: TASK-37L
title: Onboarding new session modal
status: pending
type: frontend
team: frontend
...
## Goal
Add modal confirmation for starting, changing, or clearing local session context.
...
- The task goal is completed: Add modal confirmation for starting, changing, or clearing local session context.
...
4. Commit with a clear TASK-37L message.
