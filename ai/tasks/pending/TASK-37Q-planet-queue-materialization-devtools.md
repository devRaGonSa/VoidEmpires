...
---
id: TASK-37Q
title: Planet queue materialization devtools
status: pending
type: frontend
team: frontend
...
## Goal
Move due-queue materialization into DevelopmentToolsPanel with explicit modal confirmation and backend-first refresh.
...
8. Preserve GameModal confirmation and backend-first refresh behavior for every mutating action.
...
- The task goal is completed: Move due-queue materialization into DevelopmentToolsPanel with explicit modal confirmation and backend-first refresh.
...
4. Commit with a clear TASK-37Q message.
