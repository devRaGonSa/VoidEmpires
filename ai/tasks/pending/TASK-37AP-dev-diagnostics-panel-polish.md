...
---
id: TASK-37AP
title: Dev diagnostics panel polish
status: pending
type: frontend
team: frontend
...
## Goal
Polish DevDiagnosticsPanel so raw ids and payloads are available but not visually dominant.
...
- The task goal is completed: Polish DevDiagnosticsPanel so raw ids and payloads are available but not visually dominant.
...
4. Commit with a clear TASK-37AP message.
