...
---
id: TASK-37AD
title: Fleet command preview no mutation
status: pending
type: frontend
team: frontend
...
## Goal
Add a non-mutating fleet command preview/readiness section for future movement/mission flow.
...
- The task goal is completed: Add a non-mutating fleet command preview/readiness section for future movement/mission flow.
...
4. Commit with a clear TASK-37AD message.
