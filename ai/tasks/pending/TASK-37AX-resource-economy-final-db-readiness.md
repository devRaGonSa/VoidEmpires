...
---
id: TASK-37AX
title: Resource economy final DB readiness
status: pending
type: documentation
team: gameplay
...
## Goal
Document resource economy values and final DB dependencies without changing balance.
...
- The task goal is completed: Document resource economy values and final DB dependencies without changing balance.
...
4. Commit with a clear TASK-37AX message.
