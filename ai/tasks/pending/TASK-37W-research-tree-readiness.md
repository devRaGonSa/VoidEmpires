...
## Goal
Prepare a lightweight technology tree/readiness view when data allows, otherwise document the final DB/catalog gap.
...
- The task goal is completed: Prepare a lightweight technology tree/readiness view when data allows, otherwise document the final DB/catalog gap.
...
4. Commit with a clear TASK-37W message.
