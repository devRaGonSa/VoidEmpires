...
---
id: TASK-37J
title: Resource display helper hardening
status: pending
type: frontend
team: frontend
...
## Goal
Harden resource display utilities so raw ids map to readable names where feasible.
...
- The task goal is completed: Harden resource display utilities so raw ids map to readable names where feasible.
...
4. Commit with a clear TASK-37J message.
