...
---
id: TASK-38Q
title: Research catalog finalization
status: pending
type: backend
team: gameplay
...
## Goal
Prepare final research catalog metadata without breaking research queue behavior.
...
9. Add or refine technology metadata for category, role, descriptions, level rules, prerequisites, image keys, icon keys, tags, and sort order.
10. Preserve research enqueue and materialization behavior while shifting authoritative metadata ownership to the backend or chosen source files.
...
- Research catalog metadata includes the requested fields or documents safe deferrals.
- Research enqueue and materialization behavior remains intact.
