...
---
id: TASK-37BF
title: Dev scripts final polish
status: pending
type: tooling
team: platform
...
## Goal
Polish QA script output with copy-safe commands, readable resource names, UTF-8, and actionable offline errors.
...
- The task goal is completed: Polish QA script output with copy-safe commands, readable resource names, UTF-8, and actionable offline errors.
...
4. Commit with a clear TASK-37BF message.
