...
## Goal
Create a data validation report summarizing catalog completeness and remaining risks before the final database phase.
...
9. List the catalogs, entry counts, missing metadata, missing image keys, missing prerequisites, and other pre-final-database risks.
10. Use the report to make remaining gaps visible instead of burying them in implementation details.

## Files to read first
- AGENTS.md
- docs/dev/final-catalog-audit.md
- docs/dev/final-balance-review.md
- src/VoidEmpires.Application/
- src/VoidEmpires.Infrastructure/

## Expected files to modify
- docs/dev/data-validation-report.md
...
- The report lists catalog counts and missing metadata categories clearly.
- Remaining risks before the final DB phase are called out explicitly.
