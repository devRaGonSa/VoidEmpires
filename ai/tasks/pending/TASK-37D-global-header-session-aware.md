...
---
id: TASK-37D
title: Global header session aware
status: pending
type: frontend
team: frontend
...
## Goal
Replace mock global user/resource header with truthful Development/local-session status.
...
- The task goal is completed: Replace mock global user/resource header with truthful Development/local-session status.
...
4. Commit with a clear TASK-37D message.
