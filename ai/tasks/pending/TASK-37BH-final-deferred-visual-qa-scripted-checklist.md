...
---
id: TASK-37BH
title: Final deferred visual QA scripted checklist
status: pending
type: documentation
team: platform
...
## Goal
Create final visual QA checklist with screenshots to capture for every major page and playable action.
...
- The task goal is completed: Create final visual QA checklist with screenshots to capture for every major page and playable action.
...
4. Commit with a clear TASK-37BH message.
