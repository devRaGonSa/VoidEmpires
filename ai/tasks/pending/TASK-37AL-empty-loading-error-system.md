...
---
id: TASK-37AL
title: Empty loading error system
status: pending
type: frontend
team: frontend
...
## Goal
Standardize empty, loading, and error states across pages in Spanish-first copy.
...
- The task goal is completed: Standardize empty, loading, and error states across pages in Spanish-first copy.
...
4. Commit with a clear TASK-37AL message.
