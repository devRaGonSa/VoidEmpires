...
---
id: TASK-37R
title: Construction page final declutter
status: pending
type: frontend
team: frontend
...
## Goal
Reorganize Construction so queue and catalog appear early with less repeated session/dev content.
...
- The task goal is completed: Reorganize Construction so queue and catalog appear early with less repeated session/dev content.
...
4. Commit with a clear TASK-37R message.
