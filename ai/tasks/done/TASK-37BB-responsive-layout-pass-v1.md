...
---
id: TASK-37BB
title: Responsive layout pass v1
status: pending
type: frontend
team: frontend
...
## Goal
Improve responsive behavior for main pages without broad redesign.
...
- The task goal is completed: Improve responsive behavior for main pages without broad redesign.
...
4. Commit with a clear TASK-37BB message.
