...
---
id: TASK-37AG
title: Espionage page product readiness
status: pending
type: frontend
team: frontend
...
## Goal
Polish Espionage as a read-only/preparation page for future intelligence gameplay.
...
- The task goal is completed: Polish Espionage as a read-only/preparation page for future intelligence gameplay.
...
4. Commit with a clear TASK-37AG message.
