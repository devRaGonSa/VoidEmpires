...
## Goal
Move completed TASK-37 files to done except remaining closure tasks and ensure pending is near-empty.
...
- The task goal is completed: Move completed TASK-37 files to done except remaining closure tasks and ensure pending is near-empty.
...
4. Commit with a clear TASK-37BP message.
