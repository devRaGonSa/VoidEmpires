...
---
id: TASK-37AK
title: Ground Army page product readiness
status: pending
type: frontend
team: frontend
...
## Goal
Polish Ground Army as read-only/preparation with no recruitment or combat mutation.
...
- The task goal is completed: Polish Ground Army as read-only/preparation with no recruitment or combat mutation.
...
4. Commit with a clear TASK-37AK message.
