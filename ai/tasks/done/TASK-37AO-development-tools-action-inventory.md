...
---
id: TASK-37AO
title: Development tools action inventory
status: pending
type: documentation
team: platform
...
## Goal
Audit Development-only UI actions and ensure mutating ones are secondary, labelled, and modal-confirmed.
...
- The task goal is completed: Audit Development-only UI actions and ensure mutating ones are secondary, labelled, and modal-confirmed.
...
4. Commit with a clear TASK-37AO message.
