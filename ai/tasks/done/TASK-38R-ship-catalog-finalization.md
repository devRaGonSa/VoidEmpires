...
---
id: TASK-38R
title: Ship catalog finalization
status: done
type: backend
team: gameplay
...
## Goal
Prepare final ship and orbital production catalog metadata without adding movement or combat systems.
...
9. Add or refine metadata for class, role, descriptions, cost, duration, requirements, stock behavior, image keys, icon keys, tags, and sort order.
10. Keep combat and movement out of scope while ensuring the shipyard and stock flows can consume the final metadata structure.
...
- Ship or orbital production metadata includes the requested fields or documents intentional deferrals.
- No movement or combat behavior is added.
