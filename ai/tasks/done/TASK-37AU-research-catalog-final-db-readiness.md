...
---
id: TASK-37AU
title: Research catalog final DB readiness
status: pending
type: documentation
team: gameplay
...
## Goal
Document and prepare research catalog technologies, categories, levels, prerequisites, image keys, and seed requirements.
...
8. Document final DB, final assets, production auth, combat, movement, market, and alliance dependencies when relevant.
...
- The task goal is completed: Document and prepare research catalog technologies, categories, levels, prerequisites, image keys, and seed requirements.
...
4. Commit with a clear TASK-37AU message.
