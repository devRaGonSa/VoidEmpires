...
## Goal
Prepare detailed plan for final DB/model consolidation, catalog seed data, migration strategy, and validation.
...
- The task goal is completed: Prepare detailed plan for final DB/model consolidation, catalog seed data, migration strategy, and validation.
...
4. Commit with a clear TASK-37BR message.
