...
## Goal
Create a handoff document listing every future image that remains deferred.
...
9. List required future images by `imageKey`, grouped by buildings, research, ships, defenses, resources, and civilization or planet assets.
10. Add concise visual description prompts where they would help a later asset-generation pass.
...
- docs/dev/final-assets-handoff.md
...
- Every deferred image is listed by stable `imageKey` group.
- Useful prompt or visual-description guidance is included without generating any images.
