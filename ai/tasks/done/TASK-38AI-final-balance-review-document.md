...
## Goal
Create a balance review document for the current catalog and starting-data assumptions.
...
9. Review starting resources, production rates, costs, durations, prerequisites, upgrade curves, and ship or defense readiness assumptions.
10. Mark obvious placeholders or balancing unknowns instead of silently cementing them as final.
...
- The document covers the requested balance dimensions and marks placeholders honestly.
- No hidden gameplay expansion is introduced under the guise of balance review.
