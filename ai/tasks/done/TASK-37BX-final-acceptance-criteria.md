...
## Goal
Write final acceptance criteria for near-product state before final DB/assets phase.
...
- The task goal is completed: Write final acceptance criteria for near-product state before final DB/assets phase.
...
4. Commit with a clear TASK-37BX message.
