...
## Goal
Ensure diagnostics endpoints and helpers are SQL Server-ready and fail safely.
...
9. Remove provider-specific assumptions from diagnostics and ensure unavailable-database failures are clear and non-mutating.
10. Keep diagnostics secondary to the product flow and avoid any diagnostic mutation side effects.
...
- Diagnostics remain non-mutating and provider-agnostic.
- Database unavailable errors are clear and safe.
