...
---
id: TASK-37B
title: Final information architecture map
status: pending
type: documentation
team: platform
...
## Goal
Define final frontend information architecture, route hierarchy, navigation rules, and readiness boundaries.
...
- The task goal is completed: Define final frontend information architecture, route hierarchy, navigation rules, and readiness boundaries.
...
4. Commit with a clear TASK-37B message.
