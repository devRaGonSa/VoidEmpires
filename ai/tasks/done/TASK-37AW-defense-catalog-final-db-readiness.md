...
---
id: TASK-37AW
title: Defense catalog final DB readiness
status: pending
type: documentation
team: gameplay
...
## Goal
Document and prepare defense catalog types, roles, costs, requirements, image keys, and combat dependencies.
...
- The task goal is completed: Document and prepare defense catalog types, roles, costs, requirements, image keys, and combat dependencies.
...
4. Commit with a clear TASK-37AW message.
