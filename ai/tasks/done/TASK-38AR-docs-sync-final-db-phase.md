...
---
id: TASK-38AR
title: Docs sync for final DB phase
status: done
type: docs
team: platform
...
## Goal
Synchronize the core readiness and phase-prep docs around SQL Server as the final database target.
...
9. Remove contradictions between product readiness, final DB prep, runbooks, and related developer docs.
10. Any remaining PostgreSQL references should be clearly historical, transitional, or removed from final-target documentation.
...
- Core docs no longer contradict each other about the final database target or migration approach.
- PostgreSQL references are either removed or clearly framed as transitional history.
