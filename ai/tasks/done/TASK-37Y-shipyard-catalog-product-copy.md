...
---
id: TASK-37Y
title: Shipyard catalog product copy
status: pending
type: frontend
team: frontend
...
## Goal
Improve ship/unit catalog copy with role, class, cost, duration, requirements, stock, and placeholders.
...
- The task goal is completed: Improve ship/unit catalog copy with role, class, cost, duration, requirements, stock, and placeholders.
...
4. Commit with a clear TASK-37Y message.
