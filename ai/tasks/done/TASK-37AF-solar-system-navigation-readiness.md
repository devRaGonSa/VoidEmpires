...
---
id: TASK-37AF
title: Solar system navigation readiness
status: pending
type: frontend
team: frontend
...
## Goal
Prepare system/planet navigation cards if data exists, otherwise document final DB/API dependency.
...
- The task goal is completed: Prepare system/planet navigation cards if data exists, otherwise document final DB/API dependency.
...
4. Commit with a clear TASK-37AF message.
