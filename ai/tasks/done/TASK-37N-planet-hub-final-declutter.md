...
---
id: TASK-37N
title: Planet hub final declutter
status: pending
type: frontend
team: frontend
...
## Goal
Make Planet the primary hub for identity, resources, production, queues, and gameplay/readiness links.
...
- The task goal is completed: Make Planet the primary hub for identity, resources, production, queues, and gameplay/readiness links.
...
4. Commit with a clear TASK-37N message.
