# TASK-15W-research-error-taxonomy-and-diagnostics
...
## Purpose
Research should be understandable even when requests fail, endpoints are unavailable or validation rejects the action.

## Current Problem
Previous pages exposed backend or English phrases too directly in the primary UI. Research should avoid repeating that pattern.

## Context
- Planet and Construction already added error mapping and diagnostics separation.
- Research should follow the same principle without making up new gameplay reasons.
