...
---
id: TASK-37BG
title: Single product demo guide
status: pending
type: documentation
team: platform
...
## Goal
Add or update one canonical demo guide for backend, frontend, session, enqueue, materialize, diagnostics, and expected states.
...
- The task goal is completed: Add or update one canonical demo guide for backend, frontend, session, enqueue, materialize, diagnostics, and expected states.
...
4. Commit with a clear TASK-37BG message.
