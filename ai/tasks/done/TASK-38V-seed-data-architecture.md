...
## Goal
Define a maintainable final seed-data architecture for catalogs and metadata.
...
9. Decide whether final seed data should live in code, JSON, SQL, EF seed configuration, or a hybrid model and justify the choice.
10. Ensure the chosen approach keeps catalog metadata authoritative in backend-owned sources instead of scattering final text across the UI.
...
- The seed-data architecture choice is documented with maintainability and SQL Server readiness in mind.
- The document explains how catalogs and metadata stay authoritative outside duplicated UI copy.
