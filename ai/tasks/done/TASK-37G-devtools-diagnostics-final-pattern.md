...
---
id: TASK-37G
title: Devtools diagnostics final pattern
status: pending
type: frontend
team: frontend
...
## Goal
Standardize Development tools and diagnostics as secondary, clearly labelled, collapsed surfaces.
...
- The task goal is completed: Standardize Development tools and diagnostics as secondary, clearly labelled, collapsed surfaces.
...
4. Commit with a clear TASK-37G message.
