...
- deferred items: SQL Server migration baseline implementation, final relational catalog ownership, final production seed architecture, and broader explicitly gated SQL Server validation
